...
import { Modal, TitleBar, Tabs, Tab, Frame, Input, Checkbox, Button } from '@react95/core';
              ...
              <Frame boxShadow="in" style={{ padding: 6 }}>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 6, borderTop: '1px dashed #868a8e', paddingTop: 6 }}>
                  <div>
                    ...
                    <Input type="text" inputMode="decimal" value={formData.monthlyWorkingHours} onChange={(e) => handleInputChange('monthlyWorkingHours', e.target.value)} style={{ width: '100%' }} />
                  </div>
                  <div>
                    <div style={{ fontSize: '0.5625rem', marginBottom: 2 }}>Günlük Standart</div>
                    <Input type="text" inputMode="decimal" value={formData.dailyWorkingHours} onChange={(e) => handleInputChange('dailyWorkingHours', e.target.value)} style={{ width: '100%' }} />
                  </div>
                </div>
              </Frame>
            </div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 8, padding: 6 }}>
              <Frame boxShadow="in" style={{ padding: 6 }}>
                ...
                <div style={{ marginBottom: 6 }}>
                  ...
                  <Input type="date" value={formData.employmentStartDate || ''} onChange={(e) => handleInputChange('employmentStartDate', e.target.value)} style={{ width: '100%' }} />
                </div>
                <div style={{ marginBottom: 6 }}>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 6 }}>
                  <div>
                    ...
                    <Input type="text" value={formData.severanceCeiling} onChange={(e) => handleInputChange('severanceCeiling', e.target.value)} style={{ width: '100%' }} />
                  </div>
                  <div>
...
const Win95ThemeSwitcher: React.FC = () => {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 6 }}>
      ...
      <div style={{ fontSize: '0.5rem', fontWeight: 700, marginTop: 4, opacity: 0.8 }}>YAZI BOYUTU</div>
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 4 }}>
        {FONT_SCALE_OPTIONS.map(opt => (
          <Button
            ...
            style={{
              fontSize: '0.5625rem', padding: '6px 4px',
              backgroundColor: fontScale === opt.value ? '#000e7a' : undefined,
              color: fontScale === opt.value ? '#ffffff' : '#1a1a1a',
            }}
          >
            {opt.label}
          </Button>
