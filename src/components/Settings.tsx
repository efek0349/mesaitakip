                ...
                <div className="flex flex-col gap-2 p-2 rounded-lg bg-white/30 dark:bg-gray-800/30 border border-gray-200 dark:border-gray-700">
                  ...
                  >
                    ...
                    <div>
                      ...
                      <span className="block text-[10px] text-gray-500 dark:text-gray-400">Aktif edilirse toplam kazanç üzerinden kesinti yapılır.</span>
                    </div>
                  </button>
                    ...
                    <div className="flex items-center gap-2 pl-8">
                      ...
                      <div className="relative flex-1 max-w-[80px]">
                        <input 
                          type="text" 
                          inputMode="decimal"
                          value={formData.salaryAttachmentRate} 
                          onFocus={(e) => e.target.select()}
                      ...
                      <span className="text-[10px] text-gray-400 italic">(Varsayılan 1/4 = %25)</span>
                    </div>
                  )}
                </div>
