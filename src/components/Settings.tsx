      ...
      <div className="bg-white dark:bg-dark-bg rounded-2xl w-full max-w-md shadow-2xl flex flex-col max-h-full">
        ...
        <div className="flex-1 overflow-y-auto p-4 space-y-6">
          ...
          <div className="space-y-4">
            <h3 className="font-semibold text-gray-800 dark:text-white flex items-center gap-2"><SettingsIcon size={18} /> Genel Ayarlar</h3>
            <div className="bg-gray-50 dark:bg-gray-700/50 rounded-xl p-4 space-y-4">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500 dark:text-gray-400 mt-1 pl-8">
                  Bu ayın son haftasında sonraki ayın günlerini gösterir.
                </p>
              </div>
              <div>
          ...
          {/* User Info */}
          <div className="space-y-4">
            <h3 className="font-semibold text-gray-800 dark:text-white flex items-center gap-2"><User size={18} /> Kullanıcı Bilgileri</h3>
          ...
          {/* Salary & Overtime */}
          <div className="space-y-4">
            <h3 className="font-semibold text-gray-800 dark:text-white flex items-center gap-2"><Briefcase size={18} /> Maaş ve Mesai</h3>
            <div className="bg-gray-50 dark:bg-gray-700/50 rounded-xl p-4 space-y-4">
              <div>
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  ...
                  <input type="time" value={formData.defaultStartTime} onChange={(e) => handleInputChange('defaultStartTime', e.target.value)} className="w-full p-2 border rounded-lg bg-white dark:bg-gray-800 dark:border-gray-600 dark:text-white" />
                </div>
                <div>
                  <label className="block text-sm font-medium text-gray-600 dark:text-gray-300 mb-1">Bitiş Saati</label>
                  <input type="time" value={formData.defaultEndTime} onChange={(e) => handleInputChange('defaultEndTime', e.target.value)} className="w-full p-2 border rounded-lg bg-white dark:bg-gray-800 dark:border-gray-600 dark:text-white" />
                </div>
              </div>
          ...
          {/* Tax Info */}
          <div className="space-y-4">
            <h3 className="font-semibold text-gray-800 dark:text-white flex items-center gap-2"><Percent size={18} /> Vergi ve Kesintiler (%)</h3>
            <div className="bg-gray-50 dark:bg-gray-700/50 rounded-xl p-4">
              <div className="grid grid-cols-2 gap-3">
                <div>
