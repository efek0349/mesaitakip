  ...
  const handleClearMonth = () => {
    ...
    return (
      <div className="bg-white rounded-2xl shadow-lg p-2 mb-4">
        ...
        <div className="flex gap-4 mb-4">
          {/* Toplam Mesai */}
          <div className="flex-1 bg-gradient-to-r from-blue-500 to-blue-600 rounded-xl p-4 text-white">
          ...
          <div className="flex-1 bg-gradient-to-r from-green-500 to-green-600 rounded-xl p-4 text-white">
            <div className="flex items-center justify-between">
              <div>
            ...
            <div className="bg-blue-50 rounded-lg p-3">
              <div className="flex items-center justify-between">
                ...
                <div className="text-right">
                  ...
                  <p className="text-blue-600 text-xs">₺{overtimeStats.normal.payment.toFixed(2)}</p>
                </div>
              </div>
            </div>
          )}
            ...
            <div className="bg-purple-50 rounded-lg p-3">
              <div className="flex items-center justify-between">
                ...
                <div className="text-right">
                  ...
                  <p className="text-purple-600 text-xs">₺{overtimeStats.sunday.payment.toFixed(2)}</p>
                </div>
              </div>
            </div>
          )}
            ...
            <div className="bg-red-50 rounded-lg p-3">
              <div className="flex items-center justify-between">
                ...
                <div className="text-right">
                  ...
                  <p className="text-red-600 text-xs">₺{overtimeStats.holiday.payment.toFixed(2)}</p>
                </div>
              </div>
            </div>
          )}
